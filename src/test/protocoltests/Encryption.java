...
public class Encryption {
    ...
    @Test
    void unLoggedUserTriesToSendAnEncryptedMessageReceivesError(){
    ...
    void emptyUsernameSendAnEncryptedMessageReceivesError(){
        ...
        outUser1.println("EAS :publicKey");
    ...
    @Test
    void userNotFoundReceivesError(){
        receiveLineWithTimeout(inUser1); //init message for the first user
        receiveLineWithTimeout(inUser2); //init message for the second user
        ...
        outUser2.println("EAS bob:publicKey");
